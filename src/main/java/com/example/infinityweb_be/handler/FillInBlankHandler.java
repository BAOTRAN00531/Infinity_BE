...
@Component
public class FillInBlankHandler implements AdminQuestionTypeHandler {

    private final QuestionRepository questionRepository;
    private final QuestionPayloadService questionPayloadService;
    private final UserRepository userRepository;

    public FillInBlankHandler(QuestionRepository questionRepository,
    ...
    @Override public String supportsKey() { return "fill_in_blank"; }

    @Override
    public void validate(QuestionUpsertRequest req) {
        Map<String, Object> p = req.getPayload();
        if (p == null || !p.containsKey("template") || !p.containsKey("blanks")) {
            throw new IllegalArgumentException("payload.template and payload.blanks are required");
        }
    ...
    public Long create(QuestionUpsertRequest req) {
        ...
        // Lưu cấu hình vào Question_Payloads
