...
@Component
public class SpeakingHandler implements AdminQuestionTypeHandler {

    private final QuestionRepository questionRepository;
    private final QuestionPayloadService payloadService;
    private final UserRepository userRepository;

    public SpeakingHandler(QuestionRepository questionRepository,
    ...
    @Override public String supportsKey() { return "speaking"; }

    @Override
    public void validate(QuestionUpsertRequest req) {
        Map<String, Object> p = req.getPayload();
        if (p == null || !p.containsKey("reference_text")) {
            throw new IllegalArgumentException("payload.reference_text is required for speaking");
        }
