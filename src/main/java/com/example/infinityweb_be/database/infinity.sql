...
ALTER TABLE Languages
    ADD flag VARCHAR(255) NOT NULL DEFAULT '';
ALTER TABLE Questions ADD level NVARCHAR(50);
ALTER TABLE Questions ADD score INT;
ALTER TABLE Question_Answers
    ADD is_case_sensitive BIT NOT NULL DEFAULT 0;
ALTER TABLE Languages ADD difficulty NVARCHAR(50);
ALTER TABLE Languages ADD popularity NVARCHAR(50);
ALTER TABLE Courses ADD level NVARCHAR(50);
ALTER TABLE Courses ADD duration NVARCHAR(50);
ALTER TABLE Courses ADD status NVARCHAR(20);
ALTER TABLE Modules ADD duration NVARCHAR(50);
ALTER TABLE Modules ADD [order] INT;
ALTER TABLE Modules ADD status NVARCHAR(20);

EXEC sp_set_session_context 'user_id', 33;  -- thay 1 bằng ID admin thật
UPDATE Modules
SET
    [order] = 1,
    duration = '1 hour',
    status = 'active'
WHERE [order] IS NULL OR duration IS NULL OR status IS NULL;
